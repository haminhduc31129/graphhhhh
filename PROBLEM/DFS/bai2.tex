...
\begin{frame}[plain]
    ...
    \begin{tcolorbox}[
        ...
        \centering
        {\color{white}\LARGE \textbf{Bài Tập về}}\\[0.2cm]
...
% ================== BÀI 1 ==================
\section{Bài 1 - Đếm thành phần liên thông}
...
\begin{frame}{Code tham khảo}
    \begin{exampleblock}{}
        \begin{center}
            \includegraphics[width=0.9\textwidth]{codemau2.png}
        \end{center}
    \end{exampleblock}
\end{frame}
...
% ================== BÀI 2 ==================
\section{Bài 2 - Đường đi ngắn nhất}
...
% ================== BÀI 3 ==================
\section{Bài 3 - Phát hiện chu trình}
...
\begin{frame}[fragile]{Solution - Bài 3}
    ...
    \begin{block}{Ý tưởng}
        ...
        \end{itemize}
    \end{block}
    \begin{exampleblock}{Code tham khảo}
        \begin{center}
            \includegraphics[width=0.645\textwidth]{codemau3.png}
        \end{center}
    \end{exampleblock}
\end{frame}
\begin{frame}{Bài toán 3 - Phát hiện chu trình}
